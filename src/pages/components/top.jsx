...
const Top = () => {
  return (
    <section className="flex flex-col lg:flex-row gap-5 items-center justify-center mt-10">
      <div className="lg:w-1/3 max-w-md w-3/4 card h-64 rounded-2xl"></div>
      <div className="lg:w-1/3 max-w-md w-3/4 bg-white h-64 rounded-2xl">
        ...
        <div className="p-5">
          <h2 className="text-5xl font-medium">1,200,000 ₮</h2>
          <p className="font-light text-gray-400 my-5">Your Income Amount</p>
